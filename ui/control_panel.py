...
class ControlPanelWidget(QWidget):
    ...
    # ------------------------------------------------------------------
    # Побудова UI (спрощена, без зайвих "коробок")
    # ------------------------------------------------------------------
    ...
    def _build_ui(self) -> None:
        ...
        func_row.setSpacing(SPACING)

        lbl_func = QLabel("Функція:", self.problem_group)
        lbl_func.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        lbl_func.setMinimumWidth(70)
        ...
        self.combo_function.setSizeAdjustPolicy(
            QComboBox.SizeAdjustPolicy.AdjustToMinimumContentsLengthWithIcon
        )

        func_row.addWidget(lbl_func)
        func_row.addWidget(self.combo_function, stretch=1)
        ...
        lbl_x0.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        lbl_x0.setMinimumWidth(70)
        ...
        x_row.addWidget(QLabel("x1:", self.problem_group))
        x_row.addWidget(self.input_x1)
        x_row.addSpacing(SPACING)
        x_row.addWidget(QLabel("x2:", self.problem_group))
        x_row.addWidget(self.input_x2)

        problem_layout.addLayout(func_row)
        problem_layout.addLayout(x_row)

        main_layout.addWidget(self.problem_group)

        # ------------------------------------------------------------------
        # Блок 2. Метод і параметри
        # ------------------------------------------------------------------
        self.method_group = QGroupBox("Метод оптимізації та параметри", self)
        ...
        # Ряд: лінійний пошук
        ls_row = QHBoxLayout()
        ls_row.setSpacing(SPACING)

        lbl_ls = QLabel("Line search:", self.method_group)
        lbl_ls.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        lbl_ls.setMinimumWidth(70)
        ...
        method_layout.addLayout(ls_row)
        method_layout.addLayout(params_row)
